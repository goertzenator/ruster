...
implement_simple_transcodable!(c_int, ruster_unsafe::enif_make_int, ruster_unsafe::enif_get_int);
implement_simple_transcodable!(c_uint, ruster_unsafe::enif_make_uint, ruster_unsafe::enif_get_uint);
implement_simple_transcodable!(c_double, ruster_unsafe::enif_make_double, ruster_unsafe::enif_get_double);
implement_simple_transcodable!(i64, ruster_unsafe::enif_make_int64, ruster_unsafe::enif_get_int64);
implement_simple_transcodable!(u64, ruster_unsafe::enif_make_uint64, ruster_unsafe::enif_get_uint64);
...
impl<T0: Decodable, T1: Decodable> Decodable for (T0,T1) {
	fn from_term(env:&Environment, term:Term) -> Result<Self, NifError> {
		unsafe {
			...
			let array:*const ruster_unsafe::ERL_NIF_TERM = std::mem::uninitialized();
			match ruster_unsafe::enif_get_tuple(transmute(env),
